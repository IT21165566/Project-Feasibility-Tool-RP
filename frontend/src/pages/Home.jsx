...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full flex justify-between items-center px-6 py-3 bg-white/80 z-50">
            
            {/* Logo Section */}
            <div className="flex items-center gap-3">
                <img src={HDimg} alt="Logo" className="w-10 h-10 rounded-full shadow-md" />
            ...
            <div className="flex items-center gap-3">
                <img
                    src={prfImage}
                    alt="User"
                    className="w-10 h-10 rounded-full border-2 border-gray-300 shadow-md hover:scale-105 transition-all"
                />
                <div className="hidden sm:block text-right">
                    ...
                    <p className="text-gray-500 text-xs sm:text-sm">
                        {loggedUser.email ? "User" : "Not Logged In"}
                    </p>
                </div>
            </div>
        </header>
...
const Step2Upload = () => {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
        >
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center w-full gap-10">
    ...
    return (
        ...
        >
            ...
            <motion.button
                ...
                className="relative z-10 mt-6 bg-white text-gray-900 px-6 py-3 rounded-xl shadow-lg 
